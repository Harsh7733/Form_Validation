      ...
      <div class="container">
        ...
        <div class="services-row">
          <div class="services-item">
            ...
            <h3>Dec - Feb</h3>
            <p class="text">
Winter temperatures in Delhi ranges from 8°C and 24°C, making this the preffered time of travel. The cooler temperatures make sightseeing a real joy, and tourists can enjoy the stunning cityscape, lake tours, heritage walks, visiting museums and galleries, bird watching and more. With the festive season in full swing, Delhi plays host to an incredible nightlife and festival scene that should not be missed. Winter can lead to harmful smog, so be wary of the air quality during this season.          </div>
          ...
          <div class="services-item">
            ...
            <h3>Jul - Sep</h3>
            <p class="text">
Monsoon season temperatures sit between 26°C and 35°C, bringing with it cool, fresh air and warm rains. The evenings in monsoon season are particularly enjoyable as the heat of the day transforms into the crystalline cool of night. The buildings of Delhi sparkle in the wetter months, and there is no better time for the outdoors in the form of walks, hikes, boat rides or road trips. Mosquitoes are a staple of the season, however, so bugspray and other precautions are necessary.            </p>
                    </div>
          ...
          <div class="services-item">
            ...
            <h3>Mar - Jun</h3>
            <p class="text">
Delhi's summer months range from warm to scorching. The temperature sits between 24°C and 40°C. This can make exploration uncomfortable, as the humidity settles in layers, and makes it a good time to visit Delhi's spa's, pools and ice-skating rinks. The summer plays host to exciting evening events at the multiple rooftop bars and restaurants, giving the option for relaxation in a slightly cooler atmosphere as night brings some much-needed relief from the sun.            </p>
      ...
      <div class="container">
        ...
        <div class="featured-row">
          <div class="featured-item my-2 shadow">
            <img src="img/golden.webp" alt="featured place" />
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/udaipur.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Udaipur
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/hampi.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Hampi
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/kerala.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Kerala Backwaters
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/goa.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Goa
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/spiti.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Spiti
