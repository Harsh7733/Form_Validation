    ...
    <header class="flex">
      <div class="container">
        ...
        <div class="header-form">
          ...
          <p class="text">
The Cinque Terre in Liguria, Italy is known as the 5 Lands and is the perfect mix of old world solitude and breathtaking nature that will help turn your dreams into reality. When you step into the Cinque Terre region, you feel like you have stepped into a dream. The picturesque beauty, woven with old world charm cannot be found anywhere else in the world as it is found in Cinque Terre.          </p>
        </div>
      </div>
    </header>
    <!-- header -->
      ...
      <div class="container">
        ...
        <div class="services-row">
          <div class="services-item">
            ...
            <p class="text">
              High Season</p>
            <h3>Apr - Jun | Sep - Oct</h3>
            <p class="text">
The nicest time to visit, in terms of the weather and lack of crowds, is from April to June, and in September or October. If you're planning to swim, however, bear in mind that only the south of the country is likely to be warm enough outside the May to September period. July and August are uncomfortably hot, with temperatures of around 30ºC (86ºF), and in August many businesses, restaurants and shops close down.          </div>
...
If you're planning to visit popular areas, especially beach resorts, avoid July and especially August, when the weather can be too hot and the crowds at their most congested. In August, when most Italians are on holiday, you can expect the crush to be especially bad in the resorts, and the scene in the major historic cities – Rome, Florence, Venice – to be slightly artificial, as the only people around are fellow tourists.            </p>
          ...
          <div class="services-item">
            ...
            <h3>Nov - Mar</h3>
            <p class="text">
Winters are mild in the south of the country, Rome and below, but in the north they can be at least as cold as anywhere in the northern hemisphere, with snow in winter. Winter months tend to be foggy and cold, and snow is not uncommon. If however you don't mind a bit of a chill then the shoulder season of the winter months can be quite the pleasant, and festive, time to visit.            </p>
      ...
      <div class="container">
        ...
        <div class="featured-row">
          <div class="featured-item my-2 shadow">
            <img src="img/tuscany.webp" alt="featured place" />
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/amalfi.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Amalfi Coast
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/pompelli.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Pompeii
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/dolomites.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                The Dolomites
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/lago.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Lago di Como
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/naples.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Naples
