      ...
      <div class="container">
        ...
        <div class="services-row">
          <div class="services-item">
            ...
            <h3>Nov - Apr</h3>
            <p class="text">
        The two distinct climatic seasons in the Philippines have a marked effect on Boracay. The best time to visit is during the dry season (northeast monsoon, or amihan) from November to April, when the wind blows from the northeast, the seas of White Beach are tranquil and there's very little rain. January and February are the most pleasant months and good for traveling. Peak travel times include Christmas, Chinese New Year and Easter, when accommodation prices can rise by as much as fifty percent.
          </div>
          ...
          <div class="services-item">
            ...
            <h3>Jun - Oct</h3>
            <p class="text">
            Because of the island’s north–south orientation, White Beach takes the brunt of onshore winds during the wet season (June–Oct), so don’t expect it to look at its well-barbered best at that time. The waves can be big, washing up old coconuts, seaweed and dead branches. Many beachfront resorts and restaurants are forced to erect unsightly tarpaulins to keep out the wind and sand, and some even close during July and August, the wettest months. Accomodation rates drop accordingly and many hotels take the opportunity to reonovate. The onshore wind makes for some thrilling windsurfing and kitesurfing on White Beach (wind sports operate year-round), but other ocean activities move to calmer waters on the island’s east side.
            </p>
                    </div>
          ...
          <div class="services-item">
            ...
            <h3>Mar - Jun</h3>
            <p class="text">
          March, April and May are very hot: expect sunshine all day and temperatures to peak at a broiling 36°C. Despite the heat, this can be a good time to visit Boracay as it avoids the peaks of Christmas and Chinese New Year (keep an eye out for Easter dates), just before the heavy rains of the wet season arrive. During this time, you should be able to find a room simply by taking a stroll down White Beach and asking for vacancies – you might grab a bargain towards the end of the high season.
            </p>
      ...
      <div class="container">
        ...
        <div class="featured-row">
          <div class="featured-item my-2 shadow">
            <img src="img/batad.jpg" alt="featured place" />
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/mayon.jpg" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Mayon Volcano
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/malcapuya.jpg" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
              Malcapuya Island
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/pulag.jpg" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/coron.jpg" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Coron Bay
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/big.jpg" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
            Big Lagoon
