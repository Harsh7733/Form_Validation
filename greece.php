      ...
      <div class="container">
        ...
        <div class="services-row">
          <div class="services-item">
            ...
            <h3>Jun - Sep</h3>
            <p class="text">
          The high season in Santorini brings crowds, and for good reason. The hot, sunny weather means that the sea is at its warmest and great for swimming. Prices are at their peak, but everything is open and ferries and flights will be running most frequently. The high season is also when Santorini's nightlife is at its height as the warm weather stretches into the evenings. You will want to book in advance, but this is a great time to visit this Greek island.
          </div>
          ...
          <div class="services-item">
            ...
            <h3>Nov - Apr</h3>
            <p class="text">
            Winter in Santorini brings grey skies, cooler weather, and a greater chance of rain. From November to April, flights and ferries are less frequent and some restaurants and hotels will be closed. However, prices are at their lowest and this has been very tempting for a lot of travelers. With more people visiting in the low season, more hotels and restaurants have been staying open. If you plan your trip right, you could avoid the worst of the crowds, save a lot of money, and still be able to enjoy Santorini to the fullest.
            </p>
                    </div>
          ...
          <div class="services-item">
            ...
            <p class="text">
              Shoulder Season</p>
            <h3>May - Jun | Sep - Oct</h3>
            <p class="text">
          If you are still looking for great weather but would rather give the blazing-hot summer in Santorini a miss, visiting during the shoulder seasons is a great option. There are still a lot of tourists, but the crowds will be a lot smaller than during peak season. Everything will be open and the ferries should still be running almost all of their routes. If you are a swimmer, it may be a little chilly for sea swimming in May and October.
            </p>
      ...
      <div class="container">
        ...
        <div class="featured-row">
          <div class="featured-item my-2 shadow">
            <img src="img/meteora.webp" alt="featured place" />
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/delphi.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Delphi
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/cyclades.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Cyclades
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/athens.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Athens
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/admire corfus.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Admire Corfu's
          ...
          <div class="featured-item my-2 shadow">
            <img src="img/absorb.webp" alt="featured place" />
            <div class="featured-item-content">
              <span>
                <i class="fas fa-map-marker-alt"></i>
                Absorb Thessaloniki's
              </span>
              <div>
                <!-- <p class = "text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta sed dignissimos libero soluta illum, harum amet excepturi sit?</p> -->
              </div>
